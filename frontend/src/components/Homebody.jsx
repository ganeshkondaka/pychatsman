...
export const Homebody = () => {
  ...
  return (
    <div className='flex flex-col justify-between items-center w-full flex-1 px-52 bg-zinc-900 transition-all duration-500 ease-in-out'>
      ...
      // Centered Form when no conversations
        ...
        <>
<div className='w-full flex-1 rounded-2xl p-4 space-y-4 bg-zinc-900 scrollbar-thin scrollbar-thumb-zinc-800 scrollbar-track-zinc-900 transition-all duration-500 ease-in-out'>
      ...
      {/* Sticky Input Form */}
      <form onSubmit={handleSubmit} className='flex flex-col justify-between gap-1 w-full h-auto border border-gray-400 min-h-32 rounded-2xl p-4 mt-5 sticky bottom-0 bg-zinc-900 z-50 transition-all duration-500 '>
        <div className='h-auto'>
          <textarea
            ref={textareaRef}
            value={text}
